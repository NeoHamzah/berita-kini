...
export default function Rekomendasi() {
  ...
  useEffect(() => {
    if (data && data.posts) {
      ...
      const limitedPosts = data.posts.slice(startIndex, startIndex + itemsPerPage);
  ...
  return (
    <div className="px-18 flex flex-col w-full mt-40">
      <div className="flex flex-row justify-between">
        <h1 className="font-bold text-2xl border-l-2 border-blue-500 pl-5">Rekomendasi Untuk Anda</h1>
      ...
      {searchQuery === '' && (
        <div className="flex justify-end mt-20">
          ...
          <span className="px-4 py-2 mx-10 font-bold">{currentPage} of {totalPages}</span>
          <button
